...
in {
  ...
  xdg.configFile.nvim.source = ../../../../dotfiles/nvarch; # Add all the config in ~/.config/nvim -- you should comment this line, config for my nixos. Mopre info in docs/HYPRLAND.md
